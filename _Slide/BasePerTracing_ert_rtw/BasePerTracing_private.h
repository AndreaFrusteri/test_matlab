...
extern void BasePerTra_MATLABFunction1_Init(DW_MATLABFunction1_BasePerTra_T
  *localDW);
extern void BasePerTr_MATLABFunction1_Reset(DW_MATLABFunction1_BasePerTra_T
  *localDW);
extern void BasePerTracing_MATLABFunction1(real_T rtu_in, real_T rtu_Kp, real_T
...
extern void BasePerTrac_CurrentControl_Init(void);
extern void BasePerTra_CurrentControl_Reset(void);

#pragma CODE_SECTION (BasePerTra_CurrentControl_Const, "ramfuncs")

extern void BasePerTra_CurrentControl_Const(void);

#pragma CODE_SECTION (BasePerTracing_CurrentControl, "ramfuncs")

extern void BasePerTracing_CurrentControl(void);
void isr_int1pie1_task_fcn(void);
